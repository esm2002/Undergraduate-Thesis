...
set_property PACKAGE_PIN W16 [get_ports {din[4]}]
...
set_property PACKAGE_PIN V2 [get_ports {win[7]}]
set_property PACKAGE_PIN T3 [get_ports {win[6]}]
set_property PACKAGE_PIN T2 [get_ports {win[5]}]
set_property PACKAGE_PIN R3 [get_ports {win[4]}]
set_property PACKAGE_PIN W2 [get_ports {win[3]}]
set_property PACKAGE_PIN U1 [get_ports {win[2]}]
set_property PACKAGE_PIN T1 [get_ports {win[1]}]
set_property PACKAGE_PIN R2 [get_ports {win[0]}]
...
set_property PACKAGE_PIN V3 [get_ports {acc_o[7]}]
set_property PACKAGE_PIN W3 [get_ports {acc_o[6]}]
set_property PACKAGE_PIN U3 [get_ports {acc_o[5]}]
set_property PACKAGE_PIN V13 [get_ports {acc_o[4]}]
set_property PACKAGE_PIN V14 [get_ports {acc_o[3]}]
set_property PACKAGE_PIN U14 [get_ports {acc_o[2]}]
set_property PACKAGE_PIN U15 [get_ports {acc_o[1]}]
set_property PACKAGE_PIN U16 [get_ports {acc_o[0]}]
...
set_input_delay -clock sys_clk_pin -max 0.710 [get_ports [get_ports {{din[*]} {win[*]}}]]
set_input_delay -clock sys_clk_pin -min 0.300 [get_ports [get_ports {{din[*]} {win[*]}}]]
...
set_output_delay -clock sys_clk_pin -max 0.890 [get_ports {acc_o[*]}]
set_output_delay -clock sys_clk_pin -min -0.110 [get_ports {acc_o[*]}]
...
set_property SLEW FAST [get_ports {acc_o[7]}]
set_property SLEW FAST [get_ports {acc_o[6]}]
set_property SLEW FAST [get_ports {acc_o[5]}]
set_property SLEW FAST [get_ports {acc_o[4]}]
set_property SLEW FAST [get_ports {acc_o[3]}]
set_property SLEW FAST [get_ports {acc_o[2]}]
set_property SLEW FAST [get_ports {acc_o[1]}]
set_property SLEW FAST [get_ports {acc_o[0]}]
